# ⚡ Detektor Kehadiran Presensi BLE Ruangan ESP32
...
Deteksi presensi ruangan presisi menggunakan Bluetooth Low Energy RSSI, filtering Kalman, dan integrasi Home Assistant.
...
1. Buka file **`esp32-ble-presence-beacon.ino`** menggunakan **Arduino IDE 2.0+** atau PlatformIO.
